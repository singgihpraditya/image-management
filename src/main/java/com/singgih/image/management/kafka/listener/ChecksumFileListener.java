...
@Component
public class ChecksumFileListener {
	private final String SERVICE_NAME = "CHECKSUM_FILE";
	Logger logger = LoggerFactory.getLogger(ChecksumFileListener.class);
	...
	@KafkaListener(topics = Constants.CHECKSUM_FILE_TOPIC, groupId = Constants.GROUP_ID)

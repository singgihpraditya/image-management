...
@Component
public class InsertToDBListener {
	private final String SERVICE_NAME = "INSERT_TO_DB";
	Logger logger = LoggerFactory.getLogger(InsertToDBListener.class);
	...
	@KafkaListener(topics = Constants.INSERT_TO_DB_TOPIC, groupId = Constants.GROUP_ID)
